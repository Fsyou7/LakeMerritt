...
public class CategoryAdapter extends FragmentPagerAdapter {
    ...
    public CharSequence getPageTitle(int position) {
        if (position == 0) {
            return mContext.getString(R.string.recreation_fragment);
        } else if (position == 1){
            return mContext.getString(R.string.food_fragment);
        } else if (position == 2){
            return mContext.getString(R.string.work_fragment);
        } else {
            return mContext.getString(R.string.retail_fragment);
        }
    }
}
